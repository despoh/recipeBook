...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY =
            "com.example.recipebook.Provider.MyContentProvider";
    private static final String PRODUCTS_TABLE = "recipes";
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        int uriType = sURIMatcher.match(uri); SQLiteDatabase sqlDB = dbHelper.getWritableDatabase();
        long id = 0;
        switch (uriType) {
        ...
        getContext().getContentResolver().notifyChange(uri, null); return Uri.parse(PRODUCTS_TABLE + "/" + id);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        int uriType = sURIMatcher.match(uri);
        switch (uriType) {
            case PRODUCTS_ID: queryBuilder.appendWhere(dbHelper.COLUMN_ID + "="
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int uriType = sURIMatcher.match(uri); SQLiteDatabase sqlDB = dbHelper.getWritableDatabase(); int rowsUpdated = 0;
        switch (uriType) {
